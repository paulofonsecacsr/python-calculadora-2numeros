...
def conta(operacao, valor1, valor2, exibicao_resultado, simbolo_operacao, inverter_ordem_exibicao_valores = False):
    sleep(1)

    if inverter_ordem_exibicao_valores:
        v_exibicao1 = valor2
        v_exibicao2 = valor1
    else:
        v_exibicao1 = valor1
    ...
    print(f"{Style.RESET_ALL}{exibicao_resultado} {Style.BRIGHT + Fore.BLUE}{v_exibicao1} {Style.RESET_ALL}{simbolo_operacao} {Style.BRIGHT + Fore.BLUE}{v_exibicao2} {Style.RESET_ALL}é {Style.BRIGHT + Fore.GREEN}{operacao(valor1, valor2)}\n")
        ...
        try:
            ...
            if nome_operacao == "Encerrar":
                ...
                if nome_operacao == "Adição":
                    ...
                    if valor1 >= 0  :
                        conta(radiciacao, valor1, valor2, "O resultado de", "√", True)
                    else:
                        erro("Conta inválida")
                        carregamento("Voltando ao menu", 1)
                        continue
