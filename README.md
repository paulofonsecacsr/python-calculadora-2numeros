...
Além disso, para dar a aparência de um Website real ao meu programa, fiz uso da função _sleep_ da biblioteca _time_ para criar funções responsáveis por simular um carregamento no Terminal. Ao final do projeto, decidi melhorar ainda mais a sua estética aplicando cores estratégicas em alguns textos. Para isso, aprendi a usar as ferramentas da biblioteca _colorama_*.
