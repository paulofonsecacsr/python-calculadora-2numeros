...
No desenvolvimento desse programa, busquei aplicar os conhecimento recém obtidos sobre Funcões com _return_. Trabalhei com afinco também no Tratamento de Erros, tanto no caso de respostas fora da gama de opções dada, como no caso do usuário digitar caracteres onde se pede um input do tipo _int_ ou _float_ (nesse caso, utilizando _try except_)
